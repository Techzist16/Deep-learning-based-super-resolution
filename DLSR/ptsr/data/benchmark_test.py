...
from ptsr.data import srdata_test
...
class Benchmark_test(srdata_test.SRData_Test):
    def __init__(self, cfg, name='', train=True, benchmark=True):
        super(Benchmark_test, self).__init__(cfg, name=name, train=train, benchmark=True)
